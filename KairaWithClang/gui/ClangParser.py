...
import os
libraryPath = "/home/honza/Stažené/clang+llvm-3.4-x86_64-unknown-ubuntu12.04/lib/"
tempfilepath = "/tmp/"
...
if os.path.exists(tempfilepath):
    if not os.path.isfile(tempfilepath + tempfilename):
        ...
        print "temp file was created in",tempfilepath
        
if not clang.Config.loaded:
    clang.Config.set_library_path(libraryPath)
...
class ClangParser():
    ...
    def __init__(self,completion):
        ...
        self.tu = None                
        self.options = clang.TranslationUnit.PARSE_PRECOMPILED_PREAMBLE | clang.TranslationUnit.PARSE_DETAILED_PROCESSING_RECORD | clang.TranslationUnit.PARSE_INCLUDE_BRIEF_COMMENTS_IN_CODE_COMPLETION | clang.TranslationUnit.PARSE_CACHE_COMPLETION_RESULTS #| clang.TranslationUnit.PARSE_SKIP_FUNCTION_BODIES
    ...
    def getFileAndData(self):
        ...
        print "line offset:",self.lineoffset
        """ 
        return file,data
